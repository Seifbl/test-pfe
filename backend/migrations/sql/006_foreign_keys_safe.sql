-- Migration : Clés étrangères et contraintes (version sécurisée)
-- Version: 006_foreign_keys_safe
-- Description: Nettoyage des données et ajout des relations
...
BEGIN
    ...
    -- Relations pour invitations (après nettoyage)
    ...
    RAISE NOTICE 'Migration 006_foreign_keys_safe terminée avec nettoyage des données';
END $$;
